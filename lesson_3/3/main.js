function init() {
	...
	var path = '/assets/cubemap/museum/';
	var format = '.jpg';
	...
	// loader.load('/assets/models/test-create.obj', function(object) {
	// 	// const mesh = new THREE.Mesh(object, matt);
	// 	object.traverse(function(child) {
	// 		const matt = getMaterial('standard', 'rgb(255, 255, 255)');
	// 		child.material = matt;
	// 		child.roughness = 0.875;
	// 		child.metalness = 0;
	// 		child.bumpScale = 0.175;
	// 	})
	// 	object.scale.x = 20;
	// 	object.scale.y = 20;
	// 	object.scale.z = 20;
